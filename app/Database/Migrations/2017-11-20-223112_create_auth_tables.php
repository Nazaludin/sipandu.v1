...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'user_id_best'          => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'status_sistem'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'email'                 => ['type' => 'varchar', 'constraint' => 255],
            'username'              => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'fullname'              => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'gelar_depan'           => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'gelar_belakang'        => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            ...
            'tanggal_lahir'         => ['type' => 'TIMESTAMP', 'null' => true],
            'agama'                 => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'telepon'               => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'pendidikan_terakhir'   => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'jurusan'               => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'nama_jalan_domisili'   => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'desa_domisili'         => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'kecamatan_domisili'    => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'kabupaten_domisili'    => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'provinsi_domisili'     => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'nama_foto'             => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'lokasi_foto'           => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'tipe_pegawai'          => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'jabatan'               => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'pangkat_golongan'      => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'jenis_nakes'           => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'nama_instansi'         => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'nama_jalan_instansi'   => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'desa_instansi'         => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'kecamatan_instansi'    => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'kabupaten_instansi'    => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'provinsi_instansi'     => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
