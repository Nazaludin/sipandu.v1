...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'jenis_kelamin'         => ['type' => 'VARCHAR', 'constraint' => '1', 'null' => true],
            ...
            'pendidikan_terakhir'   => ['type' => 'VARCHAR', 'constraint' => '20', 'null' => true],
            'status_kerja'                => ['type' => 'VARCHAR', 'constraint' => '20', 'null' => true],
            'jabatan'               => ['type' => 'VARCHAR', 'constraint' => '50', 'null' => true],
            'pangkat'               => ['type' => 'VARCHAR', 'constraint' => '50', 'null' => true],
            ...
            'nama_foto'               => ['type' => 'VARCHAR', 'constraint' => '50', 'null' => true],
            'lokasi_foto'               => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true],
            'nama_instansi'         => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true],
            'telepon_instansi'  => ['type' => 'VARCHAR', 'constraint' => '12', 'null' => true],
            'alamat_instansi'   => ['type' => 'VARCHAR', 'constraint' => '200', 'null' => true],
            'alamat_domisili'   => ['type' => 'VARCHAR', 'constraint' => '200', 'null' => true],
