    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Riwayat Pelatiahan</h4>
                        ...
                        <table class="table table-bordered table-responsive w-auto ">
                            <thead class="bg-success">
                                <tr>
                                    ...
                                    <th class="text-light fw-bold" scope="col">No. Sertifikat</th>
                                    <th class="text-light fw-bold" scope="col">Download Sertifikat</th>
                                </tr>
                            </thead>
