    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Pelatihan Berlangsung</h4>
                        ...
                        <table class="table table-bordered table-responsive w-auto ">
                            <thead class="bg-success">
                                <tr>
                                    ...
                                    <th class="text-light fw-bold" scope="col">Periode Pelatihan</th>
                                    <th class="text-light fw-bold" scope="col">Jenis Pelatihan/Nama Pelatihan</th>
                                    <th class="text-light fw-bold" scope="col">Sasaran Peserta</th>
                                    <th class="text-light fw-bold" scope="col">Tempat Penyelenggara</th>
