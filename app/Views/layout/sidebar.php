    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('profil'); ?>" aria-expanded="false"><i data-feather="home"></i><span class="hide-menu">Profil</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('pelatihan/berlangsung'); ?>" aria-expanded="false"><i data-feather="book"></i><span class="hide-menu">Pelatihan yang Berlangsung</span></a></li>
