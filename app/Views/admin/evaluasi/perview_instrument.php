            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <ol class="breadcrumb mt-2" aria-label="breadcrumbs">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('instrument/edit/' . $id_course); ?>">Edit</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="hidden" class="form-control-plaintext" id="floatingInputFullnameCourse" name="id_course" placeholder="Nama Instrument" required="" value="<?= $id_course; ?>">
                                    <input type="hidden" class="form-control-plaintext" id="floatingInputFullnameCourse" name="id_instrument" placeholder="Nama Instrument" required="" value="<?= $data[0]['id_instrument']; ?>">
                                </div>
                                <!-- <div class="col-12">
