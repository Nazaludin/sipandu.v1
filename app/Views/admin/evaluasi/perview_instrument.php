                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control-plaintext" id="floatingInputFullnameCourse" name="name" placeholder="Nama Instrument" value="<?= $data[0]['name']; ?>" disabled>
                                </div>
                                <div class="col-12">
                                    ...
                                    <input type="hidden" class="form-control-plaintext" id="floatingInputFullnameCourse" name="id_course" placeholder="Nama Instrument" value="<?= $id_course; ?>" disabled>
                                </div>
                                <!-- <div class="col-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control-plaintext" id="floatingInputStartRegistration" name="start_fill" value="<?= $data[0]['start_fill']; ?>" disabled>
                                    </div>
                                    <div class="col-6">
                                        <label for="floatingInputEndRegistration">Akhir Pengisian</label>
                                        <input type="date" class="form-control-plaintext" id="floatingInputEndRegistration" name="end_fill" value="<?= $data[0]['end_fill']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <!-- <textarea class="form-control" name="description" id="floatingInputSummary" cols="30" rows="10"> <?= $data[0]['description']; ?></textarea> -->
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-title mt-3">Soal
                        </div>
                        <!-- Container Card Soal -->
                                ...
                                <div class="custom-card" onclick="toggleCard(this)">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="container-question">
                                            ...
                                            <!-- <input data-input-name="pertanyaan" type="text" class="form-control-plaintext fw-bold question" name="example-text-input" value="<?= $value['question']; ?>"> -->
                                        </div>
                                        <!-- </div> -->
