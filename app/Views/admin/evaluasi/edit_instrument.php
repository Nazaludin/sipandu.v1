...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo base_url('instrument/edit/proses/' . $id_course); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="floatingInputFullnameCourse" name="name" placeholder="Nama Instrument" required="" value="<?= $data[0]['name']; ?>">
                                </div>
                                <div class="col-12">
                                    ...
                                    <input type="hidden" class="form-control" id="floatingInputFullnameCourse" name="id_instrument" placeholder="Nama Instrument" required="" value="<?= $data[0]['id_instrument']; ?>">
                                </div>
                                <!-- <div class="col-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control" id="floatingInputStartRegistration" name="start_fill" value="<?= $data[0]['start_fill']; ?>" required autofocus>
                                    </div>
                                    <div class="col-6">
                                        <label for="floatingInputEndRegistration">Akhir Pengisian</label>
                                        <input type="date" class="form-control" id="floatingInputEndRegistration" name="end_fill" value="<?= $data[0]['end_fill']; ?>" required autofocus>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-12">
