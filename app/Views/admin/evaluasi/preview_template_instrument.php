...
<div class="page-wrapper">
            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <ol class="breadcrumb mt-2" aria-label="breadcrumbs">
                        ...
                        <li class="breadcrumb-item active"><a>Lihat</a></li>
                    </ol>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo base_url('instrument/edit/proses/' . $data[0]['id_template']); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-6 d-flex justify-content-end">
                                            <a href="<?= base_url('instrument/perview/' . $data[0]['id_template']); ?>" class="btn btn-outline-primary mx-2">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input readonly type="text" class="form-control-plaintext" id="floatingInputFullnameCourse" name="name" placeholder="Nama Instrument" required="" value="<?= $data[0]['name_template']; ?>">
                                </div>
                                <div class="col-12">
                                    <!-- <label for="floatingInputFullnameCourse">ID COURSE</label> -->
                                    <input type="hidden" class="form-control-plaintext" name="id_template" value="<?= $data[0]['id_template']; ?>">
                                    <input type="hidden" class="form-control-plaintext" name="id_instrument" value="<?= $data[0]['id_instrument']; ?>">
                                </div>
                                <!-- <div class="col-12">
