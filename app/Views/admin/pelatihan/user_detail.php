                            ...
                            <div class="card-body">
                                ...
                                <div class="row px-3 justify-content-between">
                                    <div class="col-6 mb-4">
                                        <a href="<?= base_url('pelatihan/detail/user/' . $id_pelatihan); ?>" class="btn btn-outline-primary">
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <embed class="border border-dark" src="<?= $doc['link']; ?>#view=FitH&toolbar=1&navpanes=0&scrollbar=0" width="100%" height="1200" type="application/pdf">
                                                </div>
                                            </div>
                                        </div>
                                    <?php  } ?>
