                        ...
                        <div class="card-body">
                            <div class="row justify-content-between mb-2 ">
                                ...
                                <div class="col-auto">
                                    ...
                                    <?php if (json_decode($pelatihan)->courses->status_sistem != 'publish') {  ?>
                                    ...
                                    <?php } ?>
                                    <a href="<?= base_url('pelatihan/detail/edit/' . json_decode($pelatihan)->courses->id); ?>" class="btn btn-primary">
