        ...
        <div class="row d-flex align-items-center h-100">
            ...
            <div class="col-lg-7 col-md-8 col-sm-10 card flex-row m-auto border-0 rounded-5 overflow-hidden bg-transparent d-flex align-items-center justify-content-center">
                ...
                <main role="main" class="container">
                    ...
                    <form id="form-login" action="http://best-bapelkes.jogjaprov.go.id/login/index.php" method="post" target="_blank">
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-light" onclick="submitRedirectSipandu()">
                                    Klik untuk melanjutkan
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-right-lines ms-2 me-0" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <!-- <iframe name="hidden-form" src="http://best-bapelkes.jogjaprov.go.id/login/index.php" width="680" height="500" frameborder="0"></iframe> -->
                        <!-- <input type="submit" value="Klik " onclick="submitRedirectSipandu()"> -->
                    </form>
                    ...
                    <script>
                        function submitRedirectSipandu() {
                            ...
                            // Menyalin formulir dan mengubah target
                            const cloneForm = form.cloneNode(true);
                            cloneForm.removeAttribute('onsubmit'); // Menghapus event listener onsubmit untuk menghindari pemanggilan ulang

                            // Membuka tab baru
                            const newTab = window.open('', '_blank');
                            newTab.document.body.innerHTML = '<h1>Mohon tunggu...</h1>'; // Konten sementara untuk tab baru

                            // Menambahkan form baru ke dalam dokumen tab baru
                            const newForm = newTab.document.createElement('form');
                            newForm.action = cloneForm.getAttribute('action');
                            newForm.method = cloneForm.getAttribute('method');
                            newForm.innerHTML = cloneForm.innerHTML;
                            newTab.document.body.appendChild(newForm);

                            // Men-submit form baru pada tab baru
                            newForm.submit();
