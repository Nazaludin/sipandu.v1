            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <ol class="breadcrumb mt-2" aria-label="breadcrumbs">
                        <li class="breadcrumb-item active"><a>Pengisian Epp</a></li>
                    </ol>
                </div>
                <!-- Page title actions -->
                                        ...
                                        <?php if (isset(json_decode($pelatihan)->courses)) {
                                            ...
                                            foreach (json_decode($pelatihan)->courses as $key => $value) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('question/fill/' . $value->id); ?>" class="btn btn-icon btn-outline-primary m-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Pengisian">
